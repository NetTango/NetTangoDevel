...
public class Toolbar extends Touchable {
   ...
   public Toolbar(Model model) {
      ...
      /*
       * Home button - probably not final
       * 
       */
      
      button = new Button(bx + w / 12, by, bw, bh, "stop");
      button.setImage(Palette.createImage("/images/home.png", 35, new Color(22, 49, 79)));
      buttons.add(button);
   ...
   public void onClick(Button button) {
      ...
      if ("play".equals(button.getAction())) {
          ...
          * stop-button action
          */
      } else if ("stop".equals(button.getAction())) {
    	  // first pause
    	  this.pstate = 0;
    	  // then pop up model selector
    	  app.showSelector();
      }
